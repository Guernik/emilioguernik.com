---
title: "Understanding Content Structure"
description: "How your folders and files in src/content map directly to URLs on your site."
date: 2026-06-02
tags: ["sidey", "astro"]
draft: true
---

Astro takes a simple approach to routing where your folder structure is your URL structure. With [content collections](https://docs.astro.build/en/guides/content-collections/), whatever you put in `src/content` becomes a page on your site.
