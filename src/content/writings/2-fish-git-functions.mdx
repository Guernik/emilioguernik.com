...
![alt text](../../../public/images/2-fish-git-functions/image-4.png)
...
As a further improvement of my functions, I could provide some similar configuration options, or better yet, feel free to open a PR!
